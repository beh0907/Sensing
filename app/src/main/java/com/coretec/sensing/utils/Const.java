...
//
//    public static double PIXEL_PER_METER_WIDTH = 80.7f / MAP_REAL_WIDTH;
//    public static double METER_PER_PIXEL_WIDTH = MAP_REAL_WIDTH / 80.7f;
//
//    public static double PIXEL_PER_METER_HEIGHT = 34.4f / MAP_REAL_HEIGHT;
//    public static double METER_PER_PIXEL_HEIGHT = MAP_REAL_HEIGHT / 34.4f;
...
//    세로 22.4 pixel/m
    ...
    //공백이 있을 경우 결정 되는 값
    public static float MAP_REAL_WIDTH = MAP_WIDTH - LEFT_BLANK_PIXEL - RIGHT_BLANK_PIXEL;
    public static float MAP_REAL_HEIGHT = MAP_HEIGHT - TOP_BLANK_PIXEL - BOTTOM_BLANK_PIXEL;
