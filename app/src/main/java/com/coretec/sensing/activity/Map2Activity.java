...
import static com.coretec.sensing.utils.Const.DB2Path;
...
public class Map2Activity extends AppCompatActivity implements OnTouchMapListener, NavigationView.OnNavigationItemSelectedListener, View.OnClickListener {

    private ActivityMap2Binding activityBinding;
    private ContentMap2Binding contentBinding;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.nav_setting_logging:
                showSettingLoggingDialog(Map2Activity.this);
                return false;
        }
        return true;
    }
        ...
        switch (id) {
            ...
            case R.id.item_edit:
                ...
                if (isEdit) {
                    ...
                    CsvUtil.writeApCsv(new ArrayList<>(apHashMap.values()), DB2Path);
                    CsvUtil.writePoiCsv(poiArrayList, DB2Path);
                    CsvUtil.writeNodeCsv(nodeArrayList, DB2Path);
                    CsvUtil.writeLinkCsv(linkArrayList, DB2Path);
                }
                break;
    ...
    private void init() {
        //데이터 바인딩 초기화
        activityBinding = DataBindingUtil.setContentView(this, R.layout.activity_map2);
...
//        contentBinding.imgMarker.removeAllViews();
        ...
        File poiFile = new File(DB2Path, "POI.csv");
        File apFile = new File(DB2Path, "AP.csv");
        File linkFile = new File(DB2Path, "LINK.csv");
        File nodeFile = new File(DB2Path, "NODE.csv");
...
//        options.inDither = false;
        ...
        Const.setMapParam(4000f, 3000f, 80.7d, 34.4d, 317f, 200f, 695f, 820f);
...
//    ===========================================================================================
    ...
    public void onClick(View v) {
        ...
        switch (resId) {
            case R.id.btnFind:
                Intent intent = new Intent(Map2Activity.this, LocationActivity.class);
...
//        bluetoothLeScanner.startScan(leScanCallback);
    ...
    public void scanWifi() {
        ...
        if (!isLogging)
            LoadingDialog.showDialog(Map2Activity.this, "AP를 스캔 중입니다...");
    }
...
//            Log.d("RTT 실내위치 측위 보정", myLocation4.toString());
