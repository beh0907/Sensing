...
public class PointAdapter extends RecyclerView.Adapter<PointAdapter.ViewHolder> {
    ...
    public PointAdapter(ArrayList<Point> pointArrayList, RecyclerViewClickListener recyclerViewClickListener) {
        this.pointArrayList = pointArrayList;
        this.recyclerViewClickListener = recyclerViewClickListener;
    }


    public void refreshPointList(ArrayList<Point> locationList) {
        this.pointArrayList = locationList;
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        ...
        viewHolder.txtX.setText(String.format("%.4f m", point.getX()));
        viewHolder.txtY.setText(String.format("%.4f m", point.getY()));
    }
